...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  {
    name: 'update',
    endpoint: '/api/v2/public/companies/{company_id}',
    httpMethod: 'put',
  ...
  {
    name: 'retrieve',
    endpoint: '/api/v2/inventories/{inventory_id}',
    httpMethod: 'get',
  ...
  {
    name: 'retrieve',
    endpoint: '/api/v2/public/locations/{location_id}',
    httpMethod: 'get',
  ...
  {
    name: 'retrieve',
    endpoint: '/api/v2/meters/{meter_id}',
    httpMethod: 'get',
    summary: 'Get Meter',
