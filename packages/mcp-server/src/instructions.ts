...
const DEFAULT_FULL_INSTRUCTIONS = [
  ...
  '',
  'Guardrails:',
  '- Treat private message, company, contact, deal, item, order, task, estimate, invoice, subscription, payment, ticket, location, inventory, inventory transaction, expense, property, company pricing, calendar, prospecting, scoring, import, and export requests as live Sanka operations. Results and mutations must come from the dedicated MCP tools above.',
  '- For private inbox messages, companies, contacts, deals, items, orders, tasks, estimates, invoices, subscriptions, payments, tickets, locations, inventories, inventory transactions, expenses, properties, company pricing, calendar workflows, prospecting, scoring, imports, or exports, call the matching protected tool directly without first calling auth_status.',
  '- Protected Sanka tool calls are the OAuth trigger in clients like Codex, Claude, and Cursor.',
  '- Do not use search_docs or execute as a fallback for live private inbox, company, contact, deal, item, order, task, estimate, invoice, subscription, payment, ticket, location, inventory, inventory transaction, expense, property, company pricing, calendar, prospecting, scoring, import, or export work when a dedicated MCP tool covers the request.',
