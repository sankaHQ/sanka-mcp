...
const DEFAULT_FULL_INSTRUCTIONS = [
  ...
  '- For private inbox messages, companies, contacts, deals, orders, estimates, invoices, tickets, expenses, properties, calendar workflows, prospecting, or scoring, call the matching protected tool directly without first calling auth_status.',
