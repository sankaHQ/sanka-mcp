...
const DEFAULT_FULL_INSTRUCTIONS = [
  ...
  '',
  'Guardrails:',
  '- Treat private message, company, contact, deal, order, purchase order, task, estimate, invoice, payment, slip, bill, disbursement, ticket, expense, property, calendar, prospecting, and scoring requests as live Sanka operations. Results and mutations must come from the dedicated MCP tools above.',
  ...
  '- For private inbox messages, companies, contacts, deals, orders, purchase orders, tasks, estimates, invoices, overdue invoices, payments, slips, bills, disbursements, tickets, expenses, properties, calendar workflows, prospecting, or scoring, call the matching protected tool directly without first calling auth_status.',
  ...
  '- Do not use search_docs or execute as a fallback for live private inbox, company, contact, deal, order, purchase order, task, estimate, invoice, overdue invoice, payment, slip, bill, disbursement, ticket, expense, property, calendar, prospecting, or scoring work when a dedicated MCP tool covers the request.',
