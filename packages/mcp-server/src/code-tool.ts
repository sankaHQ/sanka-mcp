...
const CODE_WORKER_ENV_NAMES = [
  ...
  // TypeScript initializes its Node system on import. Permit its configuration
  // reads, but keep the host values out of the worker via codeWorkerSpawnEnv.
  'TSC_WATCHFILE',
