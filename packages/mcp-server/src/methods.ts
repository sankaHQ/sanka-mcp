...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.public.projects.create',
    fullyQualifiedName: 'public.projects.create',
    httpMethod: 'post',
    httpPath: '/api/v2/public/projects',
  },
  {
    clientCallName: 'client.public.projects.retrieve',
    fullyQualifiedName: 'public.projects.retrieve',
    httpMethod: 'get',
    httpPath: '/api/v2/public/projects/{project_id}',
  },
  {
    clientCallName: 'client.public.projects.update',
    fullyQualifiedName: 'public.projects.update',
    httpMethod: 'put',
    httpPath: '/api/v2/public/projects/{project_id}',
  },
  {
    clientCallName: 'client.public.projects.list',
    fullyQualifiedName: 'public.projects.list',
    httpMethod: 'get',
    httpPath: '/api/v2/public/projects',
  },
  {
    clientCallName: 'client.public.projects.delete',
    fullyQualifiedName: 'public.projects.delete',
    httpMethod: 'delete',
    httpPath: '/api/v2/public/projects/{project_id}',
  },
  {
  ...
  {
    clientCallName: 'client.public.ferryPrograms.list',
    fullyQualifiedName: 'public.ferryPrograms.list',
    httpMethod: 'get',
    httpPath: '/api/v2/public/ferry/programs',
  },
  {
    clientCallName: 'client.public.ferryPrograms.retrieve',
    fullyQualifiedName: 'public.ferryPrograms.retrieve',
    httpMethod: 'get',
    httpPath: '/api/v2/public/ferry/programs/{program_id}',
  },
  {
    clientCallName: 'client.public.ferryPrograms.listMeetings',
    fullyQualifiedName: 'public.ferryPrograms.listMeetings',
    httpMethod: 'get',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/meetings',
  },
  {
    clientCallName: 'client.public.ferryPrograms.createMeeting',
    fullyQualifiedName: 'public.ferryPrograms.createMeeting',
    httpMethod: 'post',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/meetings',
  },
  {
    clientCallName: 'client.public.ferryPrograms.updateMeeting',
    fullyQualifiedName: 'public.ferryPrograms.updateMeeting',
    httpMethod: 'patch',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/meetings/{meeting_id}',
  },
  {
    clientCallName: 'client.public.ferryPrograms.createTodo',
    fullyQualifiedName: 'public.ferryPrograms.createTodo',
    httpMethod: 'post',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos',
  },
  {
    clientCallName: 'client.public.ferryPrograms.batchUpsertTodos',
    fullyQualifiedName: 'public.ferryPrograms.batchUpsertTodos',
    httpMethod: 'post',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos/batch-upsert',
  },
  {
    clientCallName: 'client.public.ferryPrograms.updateTodo',
    fullyQualifiedName: 'public.ferryPrograms.updateTodo',
    httpMethod: 'patch',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos/{todo_id}',
  },
  {
    clientCallName: 'client.public.ferryPrograms.deleteTodo',
    fullyQualifiedName: 'public.ferryPrograms.deleteTodo',
    httpMethod: 'delete',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos/{todo_id}',
  },
  {
