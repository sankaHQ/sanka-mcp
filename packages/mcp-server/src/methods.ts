...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.public.ferryPrograms.docs.list',
    fullyQualifiedName: 'public.ferryPrograms.docs.list',
    httpMethod: 'get',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/meetings',
  },
  {
    clientCallName: 'client.public.ferryPrograms.docs.create',
    fullyQualifiedName: 'public.ferryPrograms.docs.create',
    httpMethod: 'post',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/meetings',
  },
  {
    clientCallName: 'client.public.ferryPrograms.docs.update',
    fullyQualifiedName: 'public.ferryPrograms.docs.update',
    httpMethod: 'patch',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/meetings/{meeting_id}',
  },
  {
    clientCallName: 'client.public.ferryPrograms.todos.create',
    fullyQualifiedName: 'public.ferryPrograms.todos.create',
    httpMethod: 'post',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos',
  },
  {
    clientCallName: 'client.public.ferryPrograms.todos.batchUpsert',
    fullyQualifiedName: 'public.ferryPrograms.todos.batchUpsert',
    httpMethod: 'post',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos/batch-upsert',
  },
  {
    clientCallName: 'client.public.ferryPrograms.todos.update',
    fullyQualifiedName: 'public.ferryPrograms.todos.update',
    httpMethod: 'patch',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos/{todo_id}',
  },
  {
    clientCallName: 'client.public.ferryPrograms.todos.delete',
    fullyQualifiedName: 'public.ferryPrograms.todos.delete',
    httpMethod: 'delete',
    httpPath: '/api/v2/public/ferry/programs/{program_id}/todos/{todo_id}',
  },
  {
