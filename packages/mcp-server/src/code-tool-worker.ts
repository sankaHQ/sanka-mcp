...
const fuse = new Fuse(
  [
    ...
    'client.public.workspaceMessages.threads.retrieve',
    ...
    'client.public.orders.uploadAttachment',
    'client.public.projects.create',
    'client.public.projects.delete',
    'client.public.projects.list',
    'client.public.projects.retrieve',
    'client.public.projects.update',
    'client.public.jobPostings.list',
    'client.public.jobPostings.retrieve',
    'client.public.jobPostings.create',
    'client.public.jobPostings.update',
    'client.public.jobPostings.archive',
    'client.public.jobPostings.activate',
    'client.public.applicants.list',
    'client.public.applicants.retrieve',
    'client.public.applicants.create',
    'client.public.applicants.update',
    'client.public.applicants.archive',
    'client.public.applicants.activate',
    'client.public.interviews.list',
    'client.public.interviews.retrieve',
    'client.public.interviews.create',
    'client.public.interviews.update',
    'client.public.interviews.archive',
    'client.public.interviews.activate',
    'client.public.workforcePlanning.retrieveOrganization',
    'client.public.workforcePlanning.createPosition',
    'client.public.workforcePlanning.updatePosition',
    'client.public.workforcePlanning.setPositionJob',
    'client.public.workforcePlanning.setPositionOccupant',
    ...
    'client.public.estimates.uploadAttachment',
    ...
    'client.public.invoices.uploadAttachment',
    'client.public.payments.create',
    'client.public.payments.delete',
    'client.public.payments.downloadPDF',
    'client.public.payments.listAllocations',
    'client.public.payments.list',
    'client.public.payments.retrieve',
    'client.public.payments.updateAllocations',
    ...
    'client.public.bills.uploadAttachment',
