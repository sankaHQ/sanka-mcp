...
describe('profile-aware tool selection', () => {
  ...
  it('returns unified instructions from the default profile', async () => {
    ...
    expect(instructions).toContain('list_sandboxes');
    expect(instructions).toContain('get_sandbox_context');
    expect(instructions).toContain('create_sandbox');
    expect(instructions).toContain('sync_sandbox_data');
    expect(instructions).toContain('get_sandbox_diff');
    expect(instructions).toContain('refresh_sandbox');
    expect(instructions).toContain('delete_sandbox');
    ...
    expect(instructions).toContain('list_invoice_line_items');
    ...
    expect(instructions).toContain('start_bill_attachment_upload');
    expect(instructions).toContain('append_bill_attachment_upload_chunk');
    expect(instructions).toContain('finish_bill_attachment_upload');
    ...
    expect(instructions).toContain('start_order_attachment_upload');
    expect(instructions).toContain('append_order_attachment_upload_chunk');
    expect(instructions).toContain('finish_order_attachment_upload');
    expect(instructions).toContain('upload_purchase_order_attachment');
    expect(instructions).toContain('start_purchase_order_attachment_upload');
    expect(instructions).toContain('append_purchase_order_attachment_upload_chunk');
    expect(instructions).toContain('finish_purchase_order_attachment_upload');
    expect(instructions).toContain('upload_estimate_attachment');
    expect(instructions).toContain('start_estimate_attachment_upload');
    expect(instructions).toContain('append_estimate_attachment_upload_chunk');
    expect(instructions).toContain('finish_estimate_attachment_upload');
    expect(instructions).toContain('upload_invoice_attachment');
    expect(instructions).toContain('start_invoice_attachment_upload');
    expect(instructions).toContain('append_invoice_attachment_upload_chunk');
    expect(instructions).toContain('finish_invoice_attachment_upload');
